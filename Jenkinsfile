...
def jettyBaseFullVersionMap = ['9.4.12-NO-LOGGER-SNAPSHOT':'9.4','9.4.12-SNAPSHOT':'9.4','9.4.11.v20180605':'9.4'] // ['9.2':'9.2.22.v20170606', '9.3':'9.3.20.v20170531', '9.4':'9.4.8.v20171121', '9.4':'9.4.10-SNAPSHOT']
...
loaderRunningTimes = ["300","600"]//"300"
loaderRates = ["100","300","500"]
            ...
            node( 'load-test-server-node' ) {
              ...
              stage( "starting jetty app ${jettyVersion}" ) {
                withEnv( ["JAVA_HOME=${tool "$jdk"}"] ) {
                  ...
                  waitUntil {
                    sh "wget -q --retry-connrefused -O foo.html --tries=200 --waitretry=20 http://localhost:$loadServerPort"
                    return true
                  }
